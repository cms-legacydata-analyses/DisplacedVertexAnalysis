...
TFile *fZZ = new TFile("ZZ_electron.root");
TFile *fWZ = new TFile("WZ_electron.root");
TFile *fWW = new TFile("WW_electron.root");
TFile *fDY = new TFile("DY_electron.root");
TFile *fll = new TFile("LL_electron.root");
TFile *fDat = new TFile("electron.root");
...
double ll_lxy_err_scale = 0.025*lumi*1/(4000);
hll_lxy_err->Scale(ll_lxy_err_scale);
hDat_lxy_err->Scale(1);
...
double ll_InvMass_scale = 0.025*lumi*1/(4000);
hll_InvMass->Scale(ll_InvMass_scale);
hDat_InvMass->Scale(1);
...
hll_InvMass->SetMaximum(10000);
hll_InvMass->SetMinimum(.04);
...
hDat_InvMass->SetYTitle("Entries / (GeV/c^{2})");
